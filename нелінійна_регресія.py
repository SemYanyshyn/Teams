...
# Обчислення прогнозованого значення y*
y_star = a * x_star**2 + b * x_star + c

print("Прогнозування за оптимальною параболічною моделлю")
print()
print(f"Модель: y* = {a}x² + {b}x + {c}")
print(f"x* = {x_star}")
print()

print("Підстановка:")
print(f"y* = {a} · {x_star}² + {b} · {x_star} + {c}")
print(f"y* = {a} · {x_star**2} + {b * x_star:.4f} + {c}")
print(f"y* = {a * x_star**2:.4f} + {b * x_star:.4f} + {c}")
print()
